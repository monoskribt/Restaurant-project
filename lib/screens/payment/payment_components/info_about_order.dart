...
class _InfoAboutOrderState extends State<InfoAboutOrder> {
          ...
          return Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  buildRow("Items total", "\$", itemsTotal.toStringAsFixed(2)),
                  ...
                  const SizedBox(height: 15),
                  if (cardDetailsProvider.showCardBanking) buildRow("Subtotal", "\$", subTotal.toStringAsFixed(2)),
                  const SizedBox(height: 15),
                  buildRow("Total", "\$", totalWithTips.toStringAsFixed(2), isTotal: true),
                ],
              ),
            ),
          );
  ...
  Widget buildRow(String title, String currencySymbol, String amount, {bool isTotal = false}) {
    return Row(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  fontFamily: "Mulish-Regular",
                  color: isTotal ? const Color(0xFFFFB080) : const Color(0xFF8E8EA9),
                ),
              ),
            ),
            Text(
